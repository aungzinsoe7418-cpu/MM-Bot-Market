...
# ---------------------------------------------------------
# 1. သင့်ရဲ့ Telegram Admin Chat ID ဂဏန်းကို အောက်တွင် ပြောင်းပါ
...
def main():
    # ---------------------------------------------------------
    # 2. သင့်ရဲ့ Bot Token အမှန်ကို အောက်ပါ "YOUR_TELEGRAM_BOT_TOKEN" နေရာတွင် ပြောင်းပါ
    app = Application.builder().token("8912157146:AAFtkWXLHV6gqqiBPaYdBBuk1ffTIs7l3Zc").build()
    # ---------------------------------------------------------
